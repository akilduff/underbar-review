(function() {
  ...
  _.filter = function(collection, test) {
    ...
    // run _.each on the collection
    // run the test function - anonymous function
    // parameters - item
    // if test of item passes, push item into result array
    // return result array
    let result = [];
  ...
  _.reduce = function(collection, iterator, accumulator) {
    ...
    // invoke _.each on the collection
    // anonymous function - invokes iterator and iterator combines item with the accumulator
  ...
  _.every = function(collection, iterator) {
    ...
    // iterator takes in accumulator and value
  ...
  _.extend = function(obj) {
    // if we get two empty objs, return an empty obj
